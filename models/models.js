...
var solution_path = path.join(__dirname, 'solution.js');
var Solution= sequelize.import(solution_path);
...
User.belongsToMany(Quiz, {through: 'Solution',as:'Solutions'});
Quiz.belongsToMany(User, {through: 'Solution',as:'Solvers'});
